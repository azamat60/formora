...
import { getGoogleAuthUrl, loginWithEmail, registerWithEmail } from '@/lib/api-client';
    ...
    <main className="mx-auto flex min-h-screen w-full max-w-6xl items-center px-4 py-10 sm:px-6">
      <section className="mx-auto w-full max-w-md rounded-3xl border border-line/80 bg-white p-7 shadow-soft sm:p-9">
        <div className="mb-6 flex items-center gap-3">
          <Image src="/logo.svg" alt="Formora" width={36} height={36} priority />
          <div>
            <p className="text-xs uppercase tracking-[0.18em] text-zinc-500">Formora</p>
        ...
        <div className="mb-5 flex items-center gap-3">
          ...
          <span className="text-xs uppercase tracking-[0.16em] text-zinc-500">or</span>
          <div className="h-px flex-1 bg-line" />
        </div>
